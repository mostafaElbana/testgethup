...
if (isset($_POST['submit'])) {
    $data['id'] = "";
    $data['name'] = rtrim(ltrim(htmlentities($_POST['name'])));
    $data['subject'] = rtrim(ltrim(htmlentities($_POST['subject'])));
    $data['name_shaher'] = rtrim(ltrim(htmlentities($_POST['name_shaher'])));
...
// if everything is ok, try to upload file
    ...
    if ($addedCare == 1) {
        die("<meta http-equiv='refresh' content='0; url=../home.php?page=service-control'> ");
    }else{
...
function selectAllCare(){
    ...
    $selectCares = new Select("service");
...
function insertIntoImage($data){
    ...
    $insertCare = new Insert($data , "service");
...
function deleteDataOfOneCare($care_id){
    ...
    $deleteCare = new Delete("service", "WHERE `id` = $care_id");
