...
if ($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "jpeg"
    ...
    if ($addedCare == 1) {
       die("<meta http-equiv='refresh' content='0; url=../home.php?page=product-control'> ");
    }else{
...
function selectAllCare(){
    ...
    $selectCares = new Select("product_img");
...
function deleteDataOfOneCare($care_id){
    ...
    $deleteCare = new Delete("product_img", "WHERE `id` = $care_id");
