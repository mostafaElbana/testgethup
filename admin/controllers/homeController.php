  ...
  /*  session_save_path("/home/users/web/b2830/ipg.rehltycom/cgi-bin/tmp");
   ...
   // $selectedCares = selectAllCare();
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($addedCare == 1) {
            die("<meta http-equiv='refresh' content='0; url=../home.php?page=home-control'> ");
        }else{
    ...
    function insertIntoImage($data){
        ...
        $insertCare = new Insert($data , "home");
    ...
    function deleteDataOfOneCare($care_id){
        ...
        $deleteCare = new Delete("home", "WHERE `id` = $care_id");
...
#delete............................
    ...
    function selectCareName($care_id){
        ...
        $selectCares = new Select("first_home");
    ...
    ####get data by name
     function getDataFromUserWhere($id){
        ...
        $selectUser = new Select("first_home");
